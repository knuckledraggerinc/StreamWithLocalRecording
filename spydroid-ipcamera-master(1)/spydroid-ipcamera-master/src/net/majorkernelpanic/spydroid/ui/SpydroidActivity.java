...
import net.majorkernelpanic.spydroid.FileMover;
import android.os.AsyncTask;
import static net.majorkernelpanic.streaming.video.VideoStream.p;
...
public class SpydroidActivity extends FragmentActivity {
    ...
    ProcessVideoFFmpeg processVideo;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < libraryAssets.length; i++) {
            try {
                ...
                FileMover fm = new FileMover(ffmpegInputStream,"/data/data/net.majorkernelpanic.spydroid/" + libraryAssets[i]);
                fm.moveIt();
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        try {
            String[] args = {"/system/bin/chmod", "755", "/data/data/net.majorkernelpanic.spydroid/ffmpeg"};
        ...
        /*  File savePath = new File(Environment.getExternalStorageDirectory().getPath() + "/.spydroidWithVideo/");
        savePath.mkdirs();*/
	...
	private void quitSpydroid() {
        ...
        // Convert to video
       /* processVideo = new ProcessVideoFFmpeg();
        processVideo.execute();*/
        ProcessVideo.isstop = true;
        Toast toast = Toast.makeText(SpydroidActivity.this, "Waiting for video..", Toast.LENGTH_LONG);
        toast.show();
    ...
    private class ProcessVideoFFmpeg extends AsyncTask<Void, Integer, Void> {
        @Override
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                String[] ffmpegCommand = {"/data/data/net.majorkernelpanic.spydroid/ffmpeg", "-r", ""+VideoStream.fps, "-vcodec", "mjpeg", "-i", Environment.getExternalStorageDirectory().getPath() + "/.spydroidWithVideo/frame_%05d.jpg", Environment.getExternalStorageDirectory().getPath() + "/videos/video_"+ts+".mov"};
                ...
                deleteFiles(Environment.getExternalStorageDirectory().getPath() + "/.spydroidWithVideo");
        ...
        protected void onPostExecute(Void... result) {
            Toast toast = Toast.makeText(SpydroidActivity.this, "Done Processing Video", Toast.LENGTH_LONG);
            toast.show();
        }
    }
